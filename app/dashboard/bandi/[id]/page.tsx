  ...
  useEffect(() => {
    ...
    const fetchBando = async () => {
      try {
        ...
        // Fetch the bando by ID, ensuring it belongs to the user's company
        ...
        if (data) {
          // Extract gap analysis from JSON field
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-muted/20 rounded-xl p-3">
                          ...
                          <div className="text-sm font-medium text-foreground">
                            {bando.publication_date ? formatDate(bando.publication_date) : "-"}
                          </div>
                        </div>
                        <div className="bg-muted/20 rounded-xl p-3">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {bando.cpv_codes.map((cpv) => (
                            <span
                              key={cpv}
                              className="flex items-center gap-1 text-xs px-2.5 py-1 rounded-lg bg-muted/30 text-foreground"
                            >
                            ...
                            <div className="flex-1">
                              ...
                              <div className="mt-2 p-2 bg-muted/30 rounded-lg">
                                <div className="text-xs text-muted-foreground">
                                  <strong>Suggerimento AI:</strong> Valuta se questo requisito e obbligatorio o preferenziale.
                                  Se preferenziale, puoi comunque partecipare con un punteggio ridotto.
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
                        ...
                        <p className="text-xs text-blue-400/80">
                          Subappalto consentito fino al 30%. Puoi coprire i gap requisiti con subappaltatori qualificati.
                        </p>
                      </div>
                      <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4">
                        ...
                        <p className="text-xs text-purple-400/80">
                          RTI consentito. Valuta partnership con aziende che hanno i requisiti mancanti.
                        </p>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="bg-muted/20 rounded-xl p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-medium text-foreground">
                          {checklistReady}/{checklistTotal} ({checklistProgress}%)
                        </span>
                      </div>
                      <div className="w-full bg-muted/30 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all ${
                            checklistProgress >= 80 ? "bg-emerald-400" :
                            checklistProgress >= 50 ? "bg-primary" :
                            "bg-amber-400"
                          }`}
                    ...
                    <div className="space-y-2">
                      {mockChecklist.map((item) => (
                        ...
                        >
                          <button
                            className={`w-5 h-5 rounded flex items-center justify-center border flex-shrink-0 mt-0.5 ${
                              item.is_ready
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <span className={`text-sm font-medium ${item.is_ready ? "text-foreground" : "text-foreground/80"}`}>
                                {item.document_name}
                              </span>
                              {item.is_long_process && (
                  ...
                  >
                    <div className="bg-primary/5 border border-primary/20 rounded-xl p-4">
                      ...
                      <p className="text-sm text-foreground/90">
                        Il ribasso medio in questo CPV (72.26) e del <strong>11.5%</strong>.
                        Considera una strategia di offerta intorno al 10-12% per essere competitivo.
                      </p>
                    </div>
            ...
            {days <= 30 && days > 0 && (
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-3">
                ...
                <p className="text-xs text-amber-400/80">
                  Il bando scade tra {days} giorni
                </p>
              </div>
            )}
          </motion.div>
