...
import { formatCurrency, formatDate } from "@/types/models"
...
export interface CounterpartDetailProps {
...
export function CounterpartDetail({ counterpart: initialCounterpart, relatedContracts }: CounterpartDetailProps) {
