...
export function InvoicesList({
  ...
  // Reload invoices when type changes
  useEffect(() => {
    ...
    fetchInvoices()
  }, [supabase, invoiceType, companyId])
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2 sm:col-span-2">
                <label className="text-sm font-medium text-foreground">Controparte *</label>
                <select
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Numero Fattura *</label>
                <Input
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Aliquota IVA *</label>
                <select
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Data Emissione *</label>
                <Input
                  type="date"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Data Scadenza *</label>
                <Input
                  type="date"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Importo Netto *</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Contratto Collegato</label>
                <select
