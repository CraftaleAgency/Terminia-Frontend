...
function ContractNewFormContent({ counterparts, employees }: ContractNewFormProps) {
...
export function ContractNewForm({ counterparts, employees }: ContractNewFormProps) {
  return (
    <Suspense fallback={
      ...
      <ContractNewFormContent counterparts={counterparts} employees={employees} />
    </Suspense>
  )
}
